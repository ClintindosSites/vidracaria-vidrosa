export const services = [
  {
    ...
    ctaDescription:
      "Peça agora seu orçamento para box de vidro temperado sob medida e transforme seu banheiro com instalação rápida, acabamento impecável e excelente custo-benefício.",
    description:
      "Transforme seu banheiro com box de vidro temperado de alta resistência, instalação profissional e garantia de qualidade.",

    heroImage: "/box-bg.webp",
    ctaImage: "/box-bg.webp",
    ...
    longDescription:
      "Instalação de box de vidro sob medida com acabamento impecável, garantindo segurança, durabilidade e um visual moderno. Trabalhamos com materiais de alta qualidade para valorizar seu banheiro com elegância e funcionalidade.",

    reviews: [
      {
        name: "Carlos Silva",
        text: "Fiquei impressionado com a qualidade do vidro e o acabamento. O box ficou perfeitamente alinhado e valorizou muito meu banheiro. Atendimento profissional do início ao fim.",
      },
      {
        name: "Fernanda Souza",
        text: "Instalação rápida, equipe organizada e muito cuidadosa. O box ficou moderno, seguro e com vedação perfeita. Recomendo para quem quer qualidade de verdade.",
      },
      {
        name: "João Pedro",
        text: "Excelente custo-benefício. O material é resistente e o acabamento realmente é de alto padrão. Cumpriram o prazo e superaram minhas expectativas.",
      },
      {
        name: "Mariana Alves",
